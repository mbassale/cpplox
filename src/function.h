...
public:
    Function() : Object(ObjectType::OBJ_FUNCTION), functionType(TYPE_FUNCTION), arity(0), upvalueCount(0), name("anonymous"), chunk(name) {}
    Function(const Function &function) : Object(ObjectType::OBJ_FUNCTION), functionType(function.functionType), arity(function.arity), upvalueCount(function.upvalueCount), name(function.name), chunk(function.chunk) {}
    Function(FunctionType functionType, const std::string &name, int arity = 0, int upvalueCount = 0) : Object(ObjectType::OBJ_FUNCTION), functionType(functionType), name(name), chunk(name), arity(arity), upvalueCount(upvalueCount) {}
