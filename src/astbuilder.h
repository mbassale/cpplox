...
class ASTBuilderImpl : public ASTBuilder {
 public:
  ...
  cpplox::ast::ProgramPtr emitProgram(const std::vector<cpplox::ast::StatementPtr> &statements) override;
  cpplox::ast::ExpressionStatementPtr emitExpressionStatement(cpplox::ast::ExpressionPtr expr) override;
  ...
  cpplox::ast::BinaryExprPtr emitBinaryOp(
      char op, cpplox::ast::ExpressionPtr lhs,
